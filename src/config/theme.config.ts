const siteUrl = (
  ...
  "https://space-lab-msu.github.io/LaSelvaMetaNetwork.github.io/"
).replace(/\/$/, "");

export const SITE = {
  name: "La Selva MetaNetwork",
  description:
  "...",
  url: siteUrl,
  locale: "en-US",
  language: "en",
  repositoryUrl: "https://github.com/SpaCE-Lab-MSU/LaSelvaMetaNetwork.github.io.git",
};
